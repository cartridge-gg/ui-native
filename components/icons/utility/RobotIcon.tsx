...
export const RobotIcon: React.FC<IconProps> = (props) => {
  return (
    <BaseIcon {...props}>
      <Rect x="6" y="8" width="12" height="10" rx="2" ry="2" stroke="currentColor" strokeWidth="2" fill="none" />
      ...
      <Path d="M20 14H18" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
