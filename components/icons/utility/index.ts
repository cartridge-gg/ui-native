...
export const utilityIcons = {
	...
	ArrowTurnDownIcon: () =>
		import("./ArrowTurnDownIcon").then((m) => m.ArrowTurnDownIcon),
	AwardIcon: () => import("./AwardIcon").then((m) => m.AwardIcon),
	AwardSimpleIcon: () =>
		import("./AwardSimpleIcon").then((m) => m.AwardSimpleIcon),
	BranchIcon: () => import("./BranchIcon").then((m) => m.BranchIcon),
	CheckIcon: () => import("./CheckIcon").then((m) => m.CheckIcon),
	CheckboxCheckedIcon: () =>
		import("./CheckboxCheckedIcon").then((m) => m.CheckboxCheckedIcon),
	CheckboxUncheckedIcon: () =>
		import("./CheckboxUncheckedIcon").then((m) => m.CheckboxUncheckedIcon),
	ChessIcon: () => import("./ChessIcon").then((m) => m.ChessIcon),
	CircleCheckIcon: () =>
		import("./CircleCheckIcon").then((m) => m.CircleCheckIcon),
	CircleNoCheckIcon: () =>
		import("./CircleNoCheckIcon").then((m) => m.CircleNoCheckIcon),
	...
	DoubleWedgeIcon: () =>
		import("./DoubleWedgeIcon").then((m) => m.DoubleWedgeIcon),
	EmptyStateAchievementIcon: () =>
		import("./EmptyStateAchievementIcon").then(
			(m) => m.EmptyStateAchievementIcon,
		),
	EmptyStateActivityIcon: () =>
		import("./EmptyStateActivityIcon").then((m) => m.EmptyStateActivityIcon),
	EmptyStateGuildIcon: () =>
		import("./EmptyStateGuildIcon").then((m) => m.EmptyStateGuildIcon),
	EmptyStateInventoryIcon: () =>
		import("./EmptyStateInventoryIcon").then((m) => m.EmptyStateInventoryIcon),
	EmptyStateLeaderboardIcon: () =>
		import("./EmptyStateLeaderboardIcon").then(
			(m) => m.EmptyStateLeaderboardIcon,
		),
	EmptyStateIcon: () =>
		import("./EmptyStateIcon").then((m) => m.EmptyStateIcon),
	ExternalIcon: () => import("./ExternalIcon").then((m) => m.ExternalIcon),
	TouchIcon: () => import("./TouchIcon").then((m) => m.TouchIcon),
	FullscreenIcon: () =>
		import("./FullscreenIcon").then((m) => m.FullscreenIcon),
	...
	MagnifyingGlassIcon: () =>
		import("./MagnifyingGlassIcon").then((m) => m.MagnifyingGlassIcon),
	MinusIcon: () => import("./MinusIcon").then((m) => m.MinusIcon),
	MirrorWedgeIcon: () =>
		import("./MirrorWedgeIcon").then((m) => m.MirrorWedgeIcon),
	...
	SpinnerPixelIcon: () =>
		import("./SpinnerPixelIcon").then((m) => m.SpinnerPixelIcon),
	SpinnerIcon: () => import("./SpinnerIcon").then((m) => m.SpinnerIcon),
	TimesCircleIcon: () =>
		import("./TimesCircleIcon").then((m) => m.TimesCircleIcon),
	...
	EmptyStateDiscoverIcon: () =>
		import("./EmptyStateDiscoverIcon").then((m) => m.EmptyStateDiscoverIcon),
};
