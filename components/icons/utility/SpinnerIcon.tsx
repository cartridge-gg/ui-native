...
export const SpinnerIcon: React.FC<IconProps> = (props) => {
	return (
		<BaseIcon {...props}>
			<Path d="M11.111 5.778c0-.491.398-.89.89-.89a7.11 7.11 0 0 1 6.158 10.668c-.245.425-.79.572-1.24.325-.4-.245-.544-.79-.3-1.24.453-.758.715-1.669.715-2.666A5.335 5.335 0 0 0 12 6.642a.873.873 0 0 1-.889-.89v.026Z" />
			<Path
