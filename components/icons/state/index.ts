...
export const stateIcons = {
  ...
  PaperPlaneIcon: () => import('./PaperPlaneIcon').then(m => m.PaperPlaneIcon),
  ...
  ShoppingCartIcon: () => import('./ShoppingCartIcon').then(m => m.ShoppingCartIcon),
  LeaderboardIcon: () => import('./LeaderboardIcon').then(m => m.LeaderboardIcon),
