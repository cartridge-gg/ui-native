...
export const loadFonts = async () => {
	await Font.loadAsync({
		...
		"Inter-Bold":
			"https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMw2boKoduKmMEVuFuYAZ9hiA.woff2",

		// IBM Plex Mono font family
		"IBMPlexMono-Regular":
			"https://fonts.gstatic.com/s/ibmplexmono/v19/-F6qfjptAgt5VM-kVkqdyU8n3kwq0n1hj-sNFQ.woff2",
		"IBMPlexMono-Medium":
			"https://fonts.gstatic.com/s/ibmplexmono/v19/-F6qfjptAgt5VM-kVkqdyU8n3oAr0n1hj-sNFQ.woff2",
		"IBMPlexMono-SemiBold":
			"https://fonts.gstatic.com/s/ibmplexmono/v19/-F6qfjptAgt5VM-kVkqdyU8n3vAo0n1hj-sNFQ.woff2",
	});
};
