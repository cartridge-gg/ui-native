...
export const MenubarMenu: React.FC<MenubarMenuProps> = ({ children, value = 'menu' }) => {
  return <>{children}</>;
};
...
export const MenubarShortcut: React.FC<MenubarShortcutProps> = ({ children }) => {
  const { colors } = useTheme();
  ...
  return (
    ...
    >
      <View style={styles.indicator}>
        {checked && <CheckIcon size="xs" variant="solid" color={colors.foreground[100]} />}
      </View>
      <Text variant="body" style={styles.text}>
        {children}
      </Text>
