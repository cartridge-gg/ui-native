	...
	({ className, children, ...props }, ref) => {
		return (
			<View
				ref={ref}
				className={cn(
					"flex-col rounded-lg overflow-hidden bg-background-100 gap-px",
					className,
				)}
				{...props}
			>
...
export const CardHeader = React.forwardRef<View, CardHeaderProps>(
	({ className, icon, children, ...props }, ref) => {
		if (icon) {
			return (
				<View
					ref={ref}
					className={cn(
						"h-10 flex-row items-center bg-background-200 gap-px",
						className,
					)}
					{...props}
				>
		...
		return (
			<View
				ref={ref}
				className={cn("flex-col gap-1 p-3 bg-background-200", className)}
				{...props}
			>
				{children}
			</View>
...
export const CardIcon = React.forwardRef<View, CardIconProps>(
	({ className, src, children, ...props }, ref) => (
		<View
			ref={ref}
			className={cn(
				"h-9 w-9 p-2 bg-background-200 justify-center items-center",
				className,
			)}
			{...props}
		>
	...
	({ className, icon, children, ...props }, ref) => {
		if (icon) {
			return (
				<View
					ref={ref}
					className={cn(
						"h-11 flex-row items-center bg-background gap-px",
						className,
					)}
					{...props}
				>
		...
		return (
			<View
				ref={ref}
				className={cn(
					"flex-col gap-1 p-3 bg-background-200 justify-between",
					className,
				)}
				{...props}
			>
...
export const CardListItemIcon = React.forwardRef<View, CardListItemIconProps>(
	({ className, src, children, ...props }, ref) => (
		<View
			ref={ref}
			className={cn(
				"h-11 w-11 bg-background-200 justify-center items-center",
				className,
			)}
			{...props}
		>
