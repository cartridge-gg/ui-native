  ...
  ({ style, icon, children, ...props }, ref) => {
    if (icon) {
      return (
        <View
          ref={ref}
          style={[styles.cardHeaderWithIcon, style]}
          {...props}
        >
          {typeof icon === "string" ? (
            <CardIcon src={icon} />
...
export const CardHeaderRight = React.forwardRef<View, CardHeaderRightProps>(
  ({ style, children, ...props }, ref) => (
    <View
      ref={ref}
      style={[styles.cardHeaderRight, style]}
      {...props}
    >
      {children}
    </View>
...
export const CardListContent = React.forwardRef<View, CardListContentProps>(
  ({ style, children, ...props }, ref) => (
    <View
      ref={ref}
      style={[styles.cardListContent, style]}
      {...props}
    >
      {children}
    </View>
  ...
  ({ style, icon, children, ...props }, ref) => {
    if (icon) {
      return (
        <View
          ref={ref}
          style={[styles.cardListItemWithIcon, style]}
          {...props}
        >
          {typeof icon === "string" ? (
          ...
          <View style={styles.cardListItemContent}>
            {children}
          </View>
        </View>
      );
    ...
    return (
      <View
        ref={ref}
        style={[styles.cardListItem, style]}
        {...props}
      >
        {children}
      </View>
...
export const CardListItemIcon = React.forwardRef<View, CardListItemIconProps>(
  ({ style, src, children, ...props }, ref) => (
    <View
      ref={ref}
      style={[styles.cardListItemIcon, style]}
      {...props}
    >
      {src ? (
        <Image
