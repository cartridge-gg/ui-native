...
export const Vertical: Story = {
  render: () => (
    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 16, height: 100 }}>
      <View style={{ flex: 1 }}>
        <Text variant="body">Left Content</Text>
        <Text variant="caption" color="secondary">Some description</Text>
      </View>
      <Separator orientation="vertical" />
      <View style={{ flex: 1 }}>
        <Text variant="body">Right Content</Text>
        <Text variant="caption" color="secondary">Another description</Text>
      </View>
    </View>
  ),
};
  ...
  render: () => (
    <View style={{ gap: 0 }}>
      <View style={{ padding: 16 }}>
        ...
        <Text variant="caption" color="secondary">Description for item 1</Text>
      </View>
      <Separator />
      <View style={{ padding: 16 }}>
        <Text variant="body">List Item 2</Text>
        <Text variant="caption" color="secondary">Description for item 2</Text>
      </View>
      <Separator />
      <View style={{ padding: 16 }}>
        <Text variant="body">List Item 3</Text>
        <Text variant="caption" color="secondary">Description for item 3</Text>
      </View>
      <Separator />
      <View style={{ padding: 16 }}>
        <Text variant="body">List Item 4</Text>
        <Text variant="caption" color="secondary">Description for item 4</Text>
      </View>
    </View>
  ),
};
  ...
  render: () => (
    <View style={{ 
      ...
      <View style={{ paddingVertical: 12 }}>
        ...
        <Text variant="caption" color="secondary">Header description</Text>
      </View>
      <Separator />
      <View style={{ paddingVertical: 12 }}>
        <Text variant="body">Card Content</Text>
        <Text variant="caption" color="secondary">Main content area</Text>
      </View>
      <Separator />
      <View style={{ paddingVertical: 12 }}>
        <Text variant="body">Card Footer</Text>
        <Text variant="caption" color="secondary">Footer information</Text>
      </View>
    </View>
  ),
};
