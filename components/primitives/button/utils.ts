...
export const buttonVariants = cva(
	"inline-flex justify-center items-center gap-1.5 rounded-md uppercase font-mono font-semibold transition-opacity focus:outline-none disabled:pointer-events-none",
	{
		variants: {
			variant: {
				primary: "bg-primary-100 hover:opacity-80 disabled:opacity-50",
				secondary:
				...
				destructive: "bg-destructive-100 shadow-sm hover:bg-destructive-100",
				outline:
			...
			status: {
				active: "bg-background-300 font-medium hover:bg-background-300",
			},
		},
		defaultVariants: {
			variant: "primary",
	...
	"text-base font-mono font-semibold uppercase tracking-wide",
	{
		variants: {
			variant: {
				...
				tertiary:
					"text-foreground-300 hover:text-foreground-200 disabled:text-foreground-400",
