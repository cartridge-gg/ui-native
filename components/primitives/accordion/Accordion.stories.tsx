	...
	render: () => (
		<Accordion type="multiple">
			<AccordionItem value="item-1">
				...
				<AccordionContent>
					<Text variant="body" color="secondary">
						This is the content for section 1. You can expand multiple sections
						at once.
					</Text>
				</AccordionContent>
			</AccordionItem>
			...
			<AccordionItem value="item-2">
				...
				<AccordionContent>
					<Text variant="body" color="secondary">
						This is the content for section 2. Both sections can be open
						simultaneously.
					</Text>
				</AccordionContent>
			</AccordionItem>
	...
	render: () => (
		<Accordion type="single" collapsible>
			<AccordionItem value="faq-1">
				...
				<AccordionContent>
					<Text variant="body" color="secondary">
						This is an accordion component that allows you to show and hide
						content sections. It's perfect for FAQs, settings panels, and
			...
			<AccordionItem value="faq-3">
				...
				<AccordionContent>
					<Text variant="body" color="secondary">
						...
						accessibilityRole and accessibilityState to work well with screen
						readers.
					</Text>
				</AccordionContent>
			</AccordionItem>
