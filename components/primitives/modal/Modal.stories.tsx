        ...
        >
          ...
          <ModalContent>
            <Text style={{ marginBottom: 12 }}>
              This modal uses the compound component pattern with separate header, content, and footer sections.
            </Text>
      ...
      <View>
        ...
        >
          ...
          {Array.from({ length: 10 }, (_, i) => (
            <Text key={i} style={{ marginBottom: 8, fontSize: 12, color: '#808080' }}>
...
export const ConfirmationDialog: Story = {
  render: () => {
    ...
    return (
      <View>
        <Button title="Delete Item" variant="destructive" onPress={() => setVisible(true)} />
