...
export const Toggle: React.FC<ToggleProps> = ({
  ...
  const variantStyles = {
    ...
    outline: pressed ? "bg-background-500 border border-input" : "bg-transparent border border-input",
  };
  ...
  const textColorClass = pressed ? "text-foreground-200" : "text-foreground-400";
