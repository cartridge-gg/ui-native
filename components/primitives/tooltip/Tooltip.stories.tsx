    ...
    <Tooltip>
      ...
      <TooltipContent>
        <View style={{ gap: 4 }}>
          ...
          <Text style={{ color: 'white', opacity: 0.8 }}>Software Engineer</Text>
  ...
  render: () => (
    <Tooltip>
      ...
      <TooltipContent>
        ...
        longer text content. The tooltip will wrap to multiple lines and maintain 
        good readability while staying within the maximum width constraint.
      </TooltipContent>
    </Tooltip>
  ),
};
