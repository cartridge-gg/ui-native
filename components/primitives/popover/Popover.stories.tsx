      ...
      <PopoverContent>
        <View style={{ gap: 12 }}>
          <View style={{ gap: 4 }}>
            ...
            <Text variant="caption" color="muted">@johndoe</Text>
          </View>
          <Text variant="body">
  ...
  render: () => (
    <View style={{ gap: 16 }}>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
        ...
        <Popover>
          <PopoverTrigger>
            <Button title="?" variant="secondary" style={{ width: 24, height: 24 }} />
          </PopoverTrigger>
          <PopoverContent>
            <View style={{ gap: 8 }}>
              <Text variant="heading-sm">Notifications</Text>
              <Text variant="body">
                When enabled, you'll receive push notifications for important updates, 
                messages, and reminders. You can customize notification preferences 
  ...
  render: () => (
    <View style={{ gap: 16 }}>
      ...
      <Popover>
        ...
        <PopoverContent>
          <Text variant="body">
            This popover is anchored to the element above, 
            but triggered by the button below.
          </Text>
        </PopoverContent>
      </Popover>
    </View>
