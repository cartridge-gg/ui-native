  ...
  render: () => (
    <View style={{ gap: 20 }}>
      <View style={{ height: 200, borderWidth: 1, borderColor: '#ccc' }}>
        <Text variant="sans-semibold-14" style={{ padding: 10 }}>Loading State:</Text>
        <LayoutContent>
          <Text variant="body" style={{ textAlign: 'center' }}>
            Loading content...
          </Text>
      ...
      <View style={{ height: 200, borderWidth: 1, borderColor: '#ccc' }}>
        <Text variant="sans-semibold-14" style={{ padding: 10 }}>Error State:</Text>
        <LayoutContent>
          <Text variant="body" style={{ textAlign: 'center', color: '#ff6b6b' }}>
