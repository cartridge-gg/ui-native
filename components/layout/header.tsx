...
export const LayoutHeader: React.FC<LayoutHeaderProps> = ({
  ...
  const IconWrapper = ({ children }: { children: React.ReactNode }) => (
    <View style={[
      styles.iconWrapper,
      variant === 'expanded' ? styles.expandedIconWrapper : styles.compressedIconWrapper
    ]}>
      {variant === 'expanded' && (
  ...
  return (
    <View style={[
      styles.container,
      variant === 'expanded' ? styles.expandedContainer : styles.compressedContainer,
      style
    ]}>
      {/* Background cover */}
      ...
      <View style={[
        ...
        variant === 'expanded' && { position: 'absolute', bottom: 0, left: 0, right: 0 }
      ]}>
        <View style={styles.leftContent}>
          ...
          <View style={styles.textContent}>
            {title && (
              <Text 
                variant={variant === 'expanded' ? 'sans-semibold-18' : 'sans-semibold-14'} 
                style={styles.title}
                numberOfLines={1}
              >
                {title}
