...
interface DojoDrawerModalProps {
  isOpen: boolean;
  onClose: () => void;
  onGameSelect?: (game: DojoGame) => void;
}

export function DojoDrawerModal({ isOpen, onClose, onGameSelect }: DojoDrawerModalProps) {
  ...
  return (
    <View className="absolute inset-0 z-50">
      ...
      <View
        className={cn(
          "absolute left-0 top-0 h-full w-80 bg-background-200 border-r border-background-300",
