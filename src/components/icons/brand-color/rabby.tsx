...
export const RabbyColorIcon = memo<IconProps>(
		...
		return (
			...
			>
				<Path
					...
					fill={`url(#paint0_linear_9302_60023-${id})`}
				/>
				<Path
					fillRule="evenodd"
					clipRule="evenodd"
					...
					fill={`url(#paint1_linear_9302_60023-${id})`}
				/>
				<Path
					fillRule="evenodd"
					clipRule="evenodd"
					...
					fill={`url(#paint2_linear_9302_60023-${id})`}
				/>
				<Path
					...
					fill={`url(#paint3_linear_9302_60023-${id})`}
				/>
				<Defs>
					<LinearGradient
						id={`paint0_linear_9302_60023-${id}`}
						x1="8.72107"
						y1="12.0892"
						x2="19.8771"
						y2="15.068"
					...
					<LinearGradient
						id={`paint1_linear_9302_60023-${id}`}
						x1="17.92"
						y1="11.8668"
						x2="9.4573"
						y2="3.87901"
					...
					<LinearGradient
						id={`paint2_linear_9302_60023-${id}`}
						x1="13.7984"
						y1="16.6178"
						x2="5.90888"
						y2="12.3469"
					...
					<LinearGradient
						id={`paint3_linear_9302_60023-${id}`}
						x1="9.38149"
						y1="12.0006"
						x2="14.9543"
						y2="18.6678"
