...
export const OlmechIcon = memo<Omit<StateIconProps, "variant"> & {
  variant:
  | "one"
  | "two"
  | "three"
            ...
            case "two":
              return (
                <>
                  ...
                  <Path d="M16 18H14V20H16V18Z" fill="currentColor" />
                </>
              );
            case "three":
              return (
              ...
              return (
                <>
                  ...
                  <Path
                    ...
                    fill="currentColor"
                  />
                  <Path d="M8 4H16V8H8V4Z" fill="currentColor" />
                  <Path d="M18 4H20V6H18V4Z" fill="currentColor" />
                  <Path d="M18 8H20V14H18V8Z" fill="currentColor" />
                  <Path
              ...
              return (
                <>
                  <Path
                    ...
                    fill="currentColor"
                  />
                  <Path d="M10 8V10H14V8H10Z" fill="currentColor" />
                  <Path
                    fillRule="evenodd"
                    clipRule="evenodd"
            ...
            case "seven":
              return (
                <>
                  ...
                  <Path d="M4 14V20H6V14H4Z" fill="currentColor" />
                  <Path d="M14 18H16V20H14V18Z" fill="currentColor" />
                  <Path d="M18 14H20V20H18V14Z" fill="currentColor" />
                </>
              );
            case "eight":
              return (
                <>
                  <Path d="M6 4H4V8H8V6H6V4Z" fill="currentColor" />
                  <Path d="M8 10V12H4V10H8Z" fill="currentColor" />
                  <Path d="M10 12H8V14H6V20H8V14H10V12Z" fill="currentColor" />
                  <Path
                    d="M10 8V12H14V14H16V20H18V14H16V12H20V10H16V12H14V8H10Z"
                    fill="currentColor"
                  />
                  <Path d="M10 16V18H14V16H10Z" fill="currentColor" />
                  <Path d="M18 4H20V8H16V6H18V4Z" fill="currentColor" />
                </>
              );
          }
        })()}
