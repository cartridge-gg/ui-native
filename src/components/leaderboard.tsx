...
function LeaderboardRow({
  ...
  return (
    <TextClassContext.Provider value={cn("text-sm font-medium text-nowrap", highlight && "fill-primary")}>
      <SvgClassContext.Provider value={highlight ? "bg-primary" : "bg-background-200"}>
        <View
          className={cn(
            "flex-row items-center space-between px-3 py-2.5",
